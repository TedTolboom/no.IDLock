  ...
  async onNodeInit () {
    ...
    if (!(this.getCommandClass('ALARM') instanceof Error)) {
      this.registerCapability('alarm_tamper', 'ALARM', {
        ...
        report: 'ALARM_REPORT',
        reportParser: report => {
          if (report && report['Alarm Type'] === 10 && Object.prototype.hasOwnProperty.call(report, 'Alarm Level')) {
      ...
      this.registerCapability('alarm_heat', 'ALARM', {
        ...
        report: 'ALARM_REPORT',
        reportParser: report => {
          if (report && report['Alarm Type'] === 4 && Object.prototype.hasOwnProperty.call(report, 'Alarm Level')) {
            return report['Alarm Level'] === 1
          }
          return null
        }
